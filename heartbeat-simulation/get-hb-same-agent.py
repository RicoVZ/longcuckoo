...
class Malware(MalwareActions):
    ...
    def init(self):
        self.moz_agent = "Mozilla/5.0 (Windows NT 6.3; WOW64; rv:53.0) Gecko/20100101 Firefox/53.0"
        self.urls = [
    ...
    def noise(self):
        noise = Traffic()
        noise.agent = "Mozilla/5.0 (Windows NT 6.3; Win64; x64) Chrome/55.0.3029.110 Safari/537.36"
